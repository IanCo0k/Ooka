    ...
    <>
        ...
        <div className='blog-wrap'>
          ...
          <p className='blog-desc'>
            ...
            <p>The Jacksonville Jaguars: Colts Kryptonite. Jacksonville yanked the rug out from under the Colts’ playoff hopes last year in a week 18 game that didn’t benefit them to win and showed up in the rematch by pitching a shutout and holding Jonathan Taylor to just 54 yards on 9 carries. The Colts trailed early on and could no longer look to their offensive specimen to drag them out of the hole. Indy snuck out a tie with Houston last week, and this loss keeps them out of the win column two weeks in. Jacksonville is the only team in the AFC South that has captured an elusive win so the Colts are far from out of the hunt, but the first two performances of a new season are alarming.</p>
            <br /><br />
