    ...
    <>
        ...
        <div className='blog-footer'>
            ...
            <div style={{ display: 'flex',  flexDirection: 'row' }}>
                <span><a href="youtube.com"><i class="fab fa-twitter"></i></a></span>
                <span><a href="youtube.com"><i class="fab fa-brands fa-linkedin"></i></a></span>
                <span><a href="youtube.com"><i class="fab fa-instagram"></i></a></span>
            </div>
        </div>
        </> 
    </>
